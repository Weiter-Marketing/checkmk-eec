        ...
        n.r(e),
            function(t) {
                ...
                function h(t) {
                    ...
                    for (var e = c(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling; )
                ...
                function N(t, e) {
                    ...
                    return (i && !n ? e.contains(u) : e === u && "BODY" !== u.nodeName) && (p = v(p, e)),
                        p
                }
                function k(t) {
                ...
                function O(t, e, n, i) {
                    ...
                    if ("viewport" === i)
                        ...
                        var f = void 0;
                        "scrollParent" === i ? "BODY" === (f = l(s(e))).nodeName && (f = t.ownerDocument.documentElement) : f = "window" === i ? t.ownerDocument.documentElement : i;
                        var d = N(f, a, o);
                        if ("HTML" !== f.nodeName || A(a))
                            r = d;
                        else {
                ...
                function M(t, e, n) {
                    return (void 0 === n ? t : t.slice(0, function(t, e, n) {
                        ...
                        return t.indexOf(i)
                            ...
                            t.enabled && r(n) && (e.offsets.popper = S(e.offsets.popper),
                    ...
                    modifiers: {
                        ...
                        arrow: {
                            ...
                            fn: function(t, e) {
                                ...
                                return y = Math.max(Math.min(s[f] - m, y), 0),
                                    t.arrowElement = i,
                                    t.offsets.arrow = (T(n = {}, c, Math.round(y)),
                                        T(n, h, ""),
                                        n),
                                    t
                            },
    ...
    SYky: function(t, e, n) {
        !function(t, e, n) {
                ...
                return e.close = function(t) {
                    ...
                    e._removeElement = function(t) {
                        ...
                        if (o.default(t).removeClass("show"),
                            ...
                            o.default(t).one(f.TRANSITION_END, (function(n) {
            ...
            o.default(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', h._handleDismiss(new h)),
                o.default.fn[d] = h._jQueryInterface,
                o.default.fn[d].Constructor = h,
                o.default.fn[d].noConflict = function() {
                    return o.default.fn[d] = c,
                        h._jQueryInterface
                }
            ;
            ...
            var g = "carousel"
                ...
                return e.next = function() {
                    ...
                    e._slide = function(t, e) {
                        var n, i, r, a = this, s = this._element.querySelector(".active.carousel-item"), l = this._getItemIndex(s), u = e || s && this._getItemByDirection(t, s), d = this._getItemIndex(u), c = Boolean(this._interval);
            ...
            o.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", E._dataApiClickHandler),
            ...
            var T = "collapse"
                ...
                return e.toggle = function() {
                    ...
                    ,
                    e._getConfig = function(t) {
                        return (t = l({}, S, t)).toggle = Boolean(t.toggle),
                    ...
                    e._getParent = function() {
                        var e, n = this;
                        f.isElement(this._config.parent) ? (e = this._config.parent,
            ...
            o.default(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', (function(t) {
                ...
                o.default.fn[T] = N._jQueryInterface,
                o.default.fn[T].Constructor = N,
                ...
                return e.toggle = function() {
                    ...
                    e._getConfig = function(t) {
                        return t = l({}, this.constructor.Default, o.default(this._element).data(), t),
                            f.typeCheckConfig(k, t, this.constructor.DefaultType),
                            t
                    }
                    ,
            ...
            o.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', L._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", L._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", L._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', (function(t) {
                    t.preventDefault(),
                        t.stopPropagation(),
                ...
                o.default.fn[k] = L._jQueryInterface,
                o.default.fn[k].Constructor = L,
                o.default.fn[k].noConflict = function() {
                    return o.default.fn[k] = A,
                        L._jQueryInterface
                }
            ;
            var j = o.default.fn.modal
                , P = {
                backdrop: !0,
                keyboard: !0,
                focus: !0,
                ...
                return e.toggle = function(t) {
                        ...
                        this._isShown && !this._isTransitioning) {
                            ...
                            this._isShown && !n.isDefaultPrevented()) {
                                ...
                                if (i && (this._isTransitioning = !0),
                                    ...
                                    o.default(this._element).one(f.TRANSITION_END, (function(t) {
                        ...
                        if (o.default(this._element).trigger(e),
                            ...
                            o.default(this._element).off(f.TRANSITION_END),
                                o.default(this._element).one(f.TRANSITION_END, (function() {
                                        ...
                                        n || o.default(t._element).one(f.TRANSITION_END, (function() {
                    ...
                    e._showBackdrop = function(t) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            o.default(this._backdrop).one(f.TRANSITION_END, t).emulateTransitionEnd(i)
                    ...
                    t._jQueryInterface = function(e, n) {
                        return this.each((function() {
                                var i = o.default(this).data("bs.modal")
                                    , r = l({}, P, o.default(this).data(), "object" == typeof e && e ? e : {});
                                if (i || (i = new t(this,r),
                ...
                for (var i = (new window.DOMParser).parseFromString(t, "text/html"), o = Object.keys(e), r = [].slice.call(i.body.querySelectorAll("*")), a = function(t, n) {
                    ...
                    s.forEach((function(t) {
                            (function(t, e) {
                                    ...
                                    if (-1 !== e.indexOf(n))
                                        return -1 === H.indexOf(n) || Boolean(t.nodeValue.match(B) || t.nodeValue.match(q));
                ...
                return e.enable = function() {
                    ...
                    e.show = function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            o.default.contains(this.element.ownerDocument.documentElement, this.tip) || o.default(a).appendTo(d),
                            ...
                            if (o.default(this.tip).hasClass("fade")) {
                                ...
                                o.default(this.tip).one(f.TRANSITION_END, c).emulateTransitionEnd(h)
                            } else
                                c()
                        }
                    }
                    ...
                    e._getConfig = function(t) {
                        ...
                        "number" == typeof t.content && (t.content = t.content.toString()),
                            f.typeCheckConfig(W, t, this.constructor.DefaultType),
                ...
                return e.refresh = function() {
                    ...
                    this._offsets = [],
                        ...
                        [].slice.call(document.querySelectorAll(this._selector)).map((function(t) {
                                var e, r = f.getSelectorFromElement(t);
                    ...
                    ,
                    e._getConfig = function(t) {
                        if ("string" != typeof (t = l({}, st, "object" == typeof t && t ? t : {})).target && f.isElement(t.target)) {
                            var e = o.default(t.target).attr("id");
                            e || (e = f.getUID(rt),
                                o.default(t.target).attr("id", e)),
                                t.target = "#" + e
                        }
                        return f.typeCheckConfig(rt, t, lt),
                            t
                    }
                    ,
            ...
            var ft = o.default.fn.tab
                ...
                return e.show = function() {
                    ...
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && o.default(this._element).hasClass("active") || o.default(this._element).hasClass("disabled"))) {
                        var e, n, i = o.default(this._element).closest(".nav, .list-group")[0], r = f.getSelectorFromElement(this._element);
                        if (i) {
            ...
            var ct = o.default.fn.toast
                ...
                return e.show = function() {
                    ...
                    ,
                    e._getConfig = function(t) {
                        return t = l({}, pt, o.default(this._element).data(), "object" == typeof t && t ? t : {}),
                    ...
                    e._close = function() {
                        ...
                        if (this._element.classList.remove("show"),
                            ...
                            o.default(this._element).one(f.TRANSITION_END, e).emulateTransitionEnd(n)
                        } else
                            e()
                    }
                    ,
...
(function(){
    ...
    console.log('event conversions script loaded locally');})();
    let script = document.createElement('script');
    script.type= "module";
    script.src = 'http://localhost/assets/js/elements.js';
